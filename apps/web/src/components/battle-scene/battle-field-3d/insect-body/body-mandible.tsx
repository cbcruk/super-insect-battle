...
export function BodyMandible({
  ...
  return (
    <group scale={scale}>
      <mesh position={[0, 0.25 * thickness, 0]}>
      ...
      <mesh position={[0, 0, 0]}>
        <sphereGeometry args={[0.45 * thickness, 16, 16, 0, Math.PI * 2, 0, Math.PI / 2]} />
        <meshStandardMaterial color={color} emissive={color} emissiveIntensity={0.3} roughness={0.3} metalness={0.4} />
      </mesh>
      <mesh position={[0, -0.08 * thickness, 0]} rotation={[Math.PI, 0, 0]}>
        <sphereGeometry args={[0.45 * thickness, 16, 16, 0, Math.PI * 2, 0, Math.PI / 2]} />
        <meshStandardMaterial color={color} emissive={color} emissiveIntensity={0.3} roughness={0.3} metalness={0.4} />
      </mesh>

      <mesh
        position={[0.25 * direction, 0.35 * thickness, 0.15]}
        rotation={[0.3, direction * 0.3, direction * -0.7]}
      >
